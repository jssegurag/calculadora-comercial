...
import com.trycore.quotizo.service.UserRoleQueryService;
...
/**
 * REST controller for managing {@link com.trycore.quotizo.domain.UserRole}.
 */
@RestController
...
public class UserRoleResource {
    ...
    public ResponseEntity<List<UserRoleDTO>> getAllUserRoles(
        UserRoleCriteria criteria,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to get UserRoles by criteria: {}", criteria);

        Page<UserRoleDTO> page = userRoleQueryService.findByCriteria(criteria, pageable);
