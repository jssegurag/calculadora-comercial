...
/**
 * Criteria class for the {@link com.trycore.quotizo.domain.Position} entity. This class is used
 * in {@link com.trycore.quotizo.web.rest.PositionResource} to receive all the possible filtering options from
...
public class PositionCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, active, createdBy, createdDate, lastModifiedBy, lastModifiedDate, resourceId, distinct);
    }
