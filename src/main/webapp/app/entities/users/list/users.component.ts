...
export class UsersComponent implements OnInit {
  ...
  trackId = (_index: number, item: IUsers): number => this.usersService.getUsersIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: IUsers[] | null): IUsers[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.usersService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
