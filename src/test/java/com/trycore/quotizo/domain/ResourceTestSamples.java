...
public class ResourceTestSamples {
    ...
    public static Resource getResourceSample1() {
        return new Resource().id(1L).createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static Resource getResourceSample2() {
        return new Resource().id(2L).createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
