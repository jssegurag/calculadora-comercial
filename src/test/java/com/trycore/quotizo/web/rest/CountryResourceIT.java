...
class CountryResourceIT {
    ...
    @Test
    @Transactional
    void getAllCountriesByCreatedDateIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedCountry = countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    void getAllCountriesByCreatedDateIsInShouldWork() throws Exception {
        // Initialize the database
        insertedCountry = countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    void getAllCountriesByCreatedDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedCountry = countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    void getAllCountriesByLastModifiedByIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedCountry = countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    void getAllCountriesByLastModifiedByIsInShouldWork() throws Exception {
        // Initialize the database
        insertedCountry = countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    void getAllCountriesByLastModifiedByIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedCountry = countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    void getAllCountriesByLastModifiedByContainsSomething() throws Exception {
        // Initialize the database
        insertedCountry = countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    void getAllCountriesByLastModifiedByNotContainsSomething() throws Exception {
        // Initialize the database
        insertedCountry = countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    void getAllCountriesByLastModifiedDateIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedCountry = countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    void getAllCountriesByLastModifiedDateIsInShouldWork() throws Exception {
        // Initialize the database
        insertedCountry = countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    void getAllCountriesByLastModifiedDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedCountry = countryRepository.saveAndFlush(country);
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.createdBy(UPDATED_CREATED_BY).lastModifiedDate(UPDATED_LAST_MODIFIED_DATE);
